  ...
  config = lib.mkIf cfg.enable {
    ...
    home-manager.users.${userName} = {
      ...
      xdg.configFile."niri/config.kdl".text = ''
        ...
        ${lib.optionalString config.apps.keepassxc.enable ''spawn-at-startup "keepassxc" "--minimized"''}
        ...
        binds {
            ...
            Mod+T { spawn "${pkgs.foot}/bin/foot" "-e" "${config.apps.otter.package}/bin/otter"; }
